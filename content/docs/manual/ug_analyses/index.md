...
![Multi-analysis sample with different pipelines and index versions](list_many.png)
...
Contigs can be sent to NCBI for a BLAST search by clicking the {{< icon "fas fa-cloud" >}} **BLAST at NCBI** button. Many contigs derived from known viruses or non-viral sources will be assembled. It is necessary to BLAST significant contigs to ensure they are novel.
